module.exports = [
  ...
  , "If it is zero degrees outside, and the weatherman says it will be twice as cold tomorrow, what temperature will it be?"
  ...
  , "If you download a movie illegally in Jamaica, does that make you a pirate of the Caribbean?"
